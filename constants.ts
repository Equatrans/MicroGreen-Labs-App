...
export const INITIAL_REVIEWS: Review[] = [
  ...
  },
  {
    ...
    userName: 'Олег В.',
    rating: 5,
    comment: 'Заказывал набор Гурман Pro. Лампа работает отлично, урожай снимаю каждые 10 дней. Рекомендую.',
    date: '2023-11-15'
  },
  {
    id: 'rev-5',
    ...
    userName: 'Елена К.',
    rating: 5,
    comment: 'Очень эстетичные лотки, вписались в интерьер кухни. Микрозелень растет как на дрожжах!',
    date: '2023-11-20'
  },
  {
    id: 'rev-6',
    ...
    userName: 'Павел Р.',
    rating: 4,
    comment: 'Хороший сервис. Хотелось бы больше вариантов семян в конструкторе, но база отличная.',
    date: '2023-11-25'
  },
  {
    id: 'rev-7',
    ...
    userName: 'Светлана М.',
    rating: 5,
    comment: 'Подарила набор маме, она теперь каждый день шлет фото своих "питомцев". Отличный подарок.',
    date: '2023-12-01'
  },
  {
    id: 'rev-8',
    ...
    userName: 'Алексей Т.',
    rating: 5,
    comment: 'Редис Санго - это что-то! Острый, красивый. Спасибо за качественные семена.',
    date: '2023-12-05'
  },
  {
    id: 'rev-9',
    ...
    userName: 'Виктория Л.',
    rating: 5,
    comment: 'Сначала сомневалась, что на льняных ковриках что-то вырастет без земли. Ошибалась! Всё чисто и вкусно.',
    date: '2023-12-08'
  },
  {
    id: 'rev-10',
    ...
    userName: 'Игорь П.',
    rating: 4,
    comment: 'Быстрая доставка. Упаковка экологичная, что для меня важно. Буду заказывать расходники.',
    date: '2023-12-12'
  },
  {
    id: 'rev-11',
    ...
    userName: 'Наталья Ф.',
    rating: 5,
    comment: 'Детский набор просто чудо. Наклейки классные, ребенок сам поливает и ждет урожай.',
    date: '2023-12-15'
  },
  {
    id: 'rev-12',
    ...
    userName: 'Сергей Б.',
    rating: 5,
    comment: 'Минималистичный дизайн сайта и самих наборов очень радует глаз. Функционально и красиво.',
    date: '2023-12-20'
  }
];
